...
local win = DiscordLib:Window("Blox fruit", _G.Color, _G.Toggle)

local serv = win:Server("klem Hub","")
...
spawn(function()
	while game:GetService("RunService").Heartbeat:wait() do
		Bone:Refresh("Total Candy : "..tostring(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Candy","Check")))
	end
end)

AutoFarm:Button("Buy random race", function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Candy","Buy",1,3)
end)

AutoFarm:Button("Buy Reset Stats", function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Candy","Buy",1,2)
end)

AutoFarm:Button("Buy Random Surprise", function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Candy","Buy",1,1)
end)

AutoFarm:Toggle("Auto Random Candy", false, function(vu)
	AutoBuySurprise = vu
end)

AutoFarm:Toggle("Auto x2 exp", false, function(vu)
    AutoBuyEXPBone = vu
end)

if Three_World then

    AutoFarm:Toggle("this is got DELETE", false, function(vu)
        TryLuck = vu
    end)

    AutoFarm:Toggle("This is got remove xd", false, function(vu)
        Pray = vu
    end)

    AutoFarm:Toggle("Auto Farm Candy", false, function(vu)
		Auto_Bone = vu
		if vu == false then
			wait(1)
			TP(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
...
elseif Three_World then
	...
	Tp:Button("Peanut Island" , function()
	   TP2(CFrame.new(-2041.73816, -7.4385643, -9854.80859, -0.999218583, 0, -0.0395277552, 0, 1, 0, 0.0395277552, 0, -0.999218583))
	end)
	Tp:Button("Ice Cream Island" , function()
	   TP2(CFrame.new(-891.057861, 54.7937012, -10891.2334, 0.790873706, -0, -0.611979425, 0, 1, -0, 0.611979425, 0, 0.790873706))
    end)
end
...
Players:Toggle("Auto Hunt Bounty (Beta) (support exploit Lv 7 >)", _G.AutoBounty, function()
	_G.AutoBounty = vu
end)
...
local Raid = serv:Channel("ESP-Raid","http://www.roblox.com/asset/?id=7251993295")
if New_World then
...
Misc:Button("Hop Lower Server (Support exploit Lv 7 >)", function()
	HopLowerServer()
end)
...
if Three_World then
	Misc:Button("Auto Torch", function()
		if not game:GetService("Players").LocalPlayer.Character:FindFirstChild("Holy Torch") and not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Holy Torch") then
			DiscordLib:Notification("Auto Holy Torch", "You dont have <Holy Torch> ", "Okay")
		else
			HolyTorch = true
...
Discord:Line()
Discord:Button("Copy Link Discord : KLEM HUB", function()
	setclipboard("https://discord.gg/YS8ZNybTa9")
end)
Discord:Label("Join discord if you want")

local Discord = serv:Channel("Discord","http://www.roblox.com/asset/?id=7044233235")
...
function CheckLevel()
	...
	if Three_World then
        ...
        elseif Lv == 2075 or Lv <= 2099 or SelectMonster == "Peanut Scout [Lv. 2075]" then --Peanut scout
            ...
            CFrameQ = CFrame.new(-2105.53223, 39.7870331, -10195.5088, -0.766061664, 0, -0.642767608, 0, 1, 0, 0.642767608, 0, -0.766061664)
		    CFrameMon = CFrame.new(-2323.74902, 38.4517822, -10177.1133, -0.662050843, 0, -0.749459445, 0, 1, 0, 0.749459445, 0, -0.662050843)
        ...
        elseif Lv == 2125 or Lv <= 2149 or SelectMonster == "Ice Cream Chef [Lv. 2125]" then --Ice Cream Chef
            ...
            QuestLv = 1
            CFrameQ = CFrame.new(-819.376526, 67.4634171, -10967.2832, -0.766061664, 0, 0.642767608, 0, 1, 0, -0.642767608, 0, -0.766061664)
		    CFrameMon = CFrame.new(-1009.8584, 68.1676636, -11214.8975, 0.790873706, -0, -0.611979425, 0, 1, -0, 0.611979425, 0, 0.790873706)
        elseif Lv == 2150 or SelectMonster == "Ice Cream Commander [Lv. 2150]" then --Ice Cream Commander
            ...
            QuestLv = 2 
            CFrameQ = CFrame.new(-819.376526, 67.4634171, -10967.2832, -0.766061664, 0, 0.642767608, 0, 1, 0, -0.642767608, 0, -0.766061664)
		    CFrameMon = CFrame.new(-600.8479, 124.118866, -11106.7588, -0.296830177, 0, 0.954930246, 0, 1, 0, -0.954930246, 0, -0.296830177)
		end
	end
end
...
warn("Easter egg : Long ago (2019/5/9) klemplus is try make Hack blox fruit but he fail ... Find easter egg 2 for read more")
